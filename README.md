# Фискальный контур Узбекистана глазами разработчика

Что нужно знать, встраивая в учётную систему требования, которые здесь предъявляет
государство: ИКПУ, онлайн-касса, фискализация онлайн-оплат, ЭСФ, маркировка.

Это заметки инженера, а не юридическая консультация. Нормы меняются — всё, что
касается сумм и дат, сверяйте с действующей редакцией законодательства.
...
## ИКПУ: у каждой позиции есть код
...
flowchart LR
    ...
    style K fill:#eef4ff,stroke:#6366f1,stroke-width:2px
```
...
## Онлайн-касса: требования расширились с 1 апреля 2026
